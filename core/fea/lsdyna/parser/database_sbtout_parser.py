...
from core.fea.lsdyna.keywords.database_sbtout import DatabaseSbtout


class DatabaseSbtoutParser(Parser):
    def __init__(self):
        super().__init__()
    ...
    def _12p0(self, line_raw):
        ...
        uid = len(self.dataframe.database_sbtout) + 1

        self.dataframe.database_sbtout[uid] = DatabaseSbtout(uid=uid,
                                                             dt=dt,
                                                             binary=binary,
                                                             lcur=lcur,
                                                             ioopt=ioopt)
